...
- 2026-08-10 — Day 2 start: added routing catalog `skills/orchestrator/references/routing.md` (task-shape→coworker table, method for routing to installed skills/agents, parallelization rules, decision procedure) and wired it into the orchestrator Match step. Updated ROADMAP/CHANGELOG/README. Done inline. Validator passes (10 items).
